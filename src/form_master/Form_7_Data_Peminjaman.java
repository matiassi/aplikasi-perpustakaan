 ...
 *
 */
public class Form_7_Data_Peminjaman extends javax.swing.JDialog {
     ...
     */
    public Form_7_Data_Peminjaman(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        String[] judul={"No Peminjaman","NIS","Nama Anggota","Kelas","Tanggal Pinjam","Batas Pengembalian","Total Buku"};
    ...
    private void detilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detilActionPerformed
        ...
        {
            Form_9_Detil_Peminjaman.public_no_peminjaman = tabel.getValueAt(jTable1.getSelectedRow(), 0).toString();
            Form_9_Detil_Peminjaman frameform = new Form_9_Detil_Peminjaman(null, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_7_Data_Peminjaman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Form_7_Data_Peminjaman dialog = new Form_7_Data_Peminjaman(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        try {
            ...
            while(re.next()){                
                ...
                while(re1.next()){
                    String[] tabel_master={re.getString(1),re1.getString(1),re1.getString(2),re1.getString(6),re.getString(3),re.getString(4),re.getString(5)};
    ...
    private void fungsi_pencarian() {
        try {
            ...
            com.mysql.jdbc.Connection koneksi = (com.mysql.jdbc.Connection) DriverManager.getConnection("jdbc:mysql://localhost/si_perpus","root","");
            ResultSet re=koneksi.createStatement().executeQuery("SELECT * FROM tbl_4_transaksi_peminjaman where no_peminjaman LIKE '%"+pencarian.getText()+"%'"
            +"or nis like '%"+pencarian.getText()+"%'"+"or tanggal_pinjam like '%" + pencarian.getText()+"%'"+"or batas_pengembalian like '%" + pencarian.getText()+"%' "
