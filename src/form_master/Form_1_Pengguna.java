 ...
 *
 */
public class Form_1_Pengguna extends javax.swing.JDialog {
     ...
     */
    public Form_1_Pengguna(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            ResultSet re=koneksi.createStatement().executeQuery("SELECT * FROM tbl_1_pengguna WHERE id_pengguna='"+jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString()+"'");
            while(re.next()){                
        ...
        if(tf_id_pengguna.getText().isEmpty()){
            ...
            if (reply == JOptionPane.YES_OPTION) {
                try {
                    ...
                    koneksi.createStatement().executeUpdate("DELETE FROM tbl_1_pengguna where id_pengguna='"+tf_id_pengguna.getText()+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_1_Pengguna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Form_1_Pengguna dialog = new Form_1_Pengguna(new javax.swing.JFrame(), true);
    ...
    private void penomoran_otomatis() {
        ...
        try {
            koneksi();
            String sql = "select id_pengguna from tbl_1_pengguna order by id_pengguna desc limit 1";                        
    ...
    private void fungsi_simpan_data() {
        try {
            Connection koneksi = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/si_perpus","root","");
            koneksi.createStatement().executeUpdate("INSERT INTO tbl_1_pengguna VALUES('"+tf_id_pengguna.getText()+"'"
    ...
    private void fungsi_ubah_data() {
        try {
            Connection koneksi = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/si_perpus","root","");
            koneksi.createStatement().executeUpdate("UPDATE tbl_1_pengguna SET id_pengguna='"+tf_id_pengguna.getText()+"'"
    ...
    private void tampil() {
        try {
            ...
            com.mysql.jdbc.Connection koneksi = (com.mysql.jdbc.Connection) DriverManager.getConnection("jdbc:mysql://localhost/si_perpus","root","");
            ResultSet re=koneksi.createStatement().executeQuery("SELECT * FROM tbl_1_pengguna ORDER BY id_pengguna");            
            while(re.next()){                
    ...
    private void fungsi_pencarian() {
        try {
            ...
            com.mysql.jdbc.Connection koneksi = (com.mysql.jdbc.Connection) DriverManager.getConnection("jdbc:mysql://localhost/si_perpus","root","");
            ResultSet re=koneksi.createStatement().executeQuery("SELECT * FROM tbl_1_pengguna where id_pengguna LIKE '%"+pencarian.getText()+"%'"
