 ...
 *
 */
public class Form_1_Cetak_Peminjaman extends javax.swing.JDialog {
    public static String public_tanggal = "";
    
    /**
     * Creates new form Form_2_Cetak_Siswa
     */
    public Form_1_Cetak_Peminjaman(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakActionPerformed
        try {
            String NamaFile = "src/laporan/Laporan_3_Peminjaman.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_1_Cetak_Peminjaman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Form_1_Cetak_Peminjaman dialog = new Form_1_Cetak_Peminjaman(new javax.swing.JFrame(), true);
